...
db_config = {
    'dbname': 'neondb',  # Nombre de la base de datos
    'user': 'neondb_owner',  # Reemplaza con tu usuario de PostgreSQL
    'password': 'npg_ci3tgnxWj4lK',  # Reemplaza con tu contrasegna
    'host': 'ep-sweet-glitter-ag90k802-pooler.c-2.eu-central-1.aws.neon.tech',  # Cambia si el host es diferente
